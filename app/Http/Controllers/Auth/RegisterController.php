    ...
    */
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            'name' => 'required|string|min:2|max:30|regex:/^(?=.{3,15}$)[A-ZÁÉÍÓÚ][a-zñáéíóú]+(?: [A-ZÁÉÍÓÚ][a-zñáéíóú]+)?$/',
        ...
        [
            ...
            'lastname.max' => 'No se aceptan apellidos de más de 30 caracteres, ni numeros, y solo la primera letra debe ser en mayuscula',
